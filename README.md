Displays a menu to moderators to create location boxes to track how often and how long users visit specific sections of an AltSpaceVR world. 
...
* VSCode: `Shift+Ctrl+B`, then select 'build Location-Tracking-MRE'.

## Run

* Command line: `npm start`.
* VSCode: Switch to the 'Run' tab (`Ctrl+Shift+D` will open it), select 'Launch LocationTracker project' from the dropdown at the top, and then `F5` to start it.
...
1. To make location boxes visible, click "Toggle Edit Mode". Click again to hide them.
2. Click "Add Location Box" to create and name a new location box. This will create a new box near the menu.
3. Click and drag the box to move it to the desired location.
4. Click "Resize" to resize the location box.
5. Click "Delete" to remove the location box.